...
type CartItemProps = {
  id:string,title:string,price:number,asize:number, count:number,type:string,imageUrl:string
}

const CartItem:React.FC<CartItemProps>  = ({id,title,price,asize, count,type,imageUrl}) => {
